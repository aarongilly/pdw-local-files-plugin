...
import { importMongo, importFirestore, importOldest } from './oneTimeImport.js';




// let epoch = pdw.makeEpochStrFrom('2023-10-04T22:56:08Z')
// let epoch2 = pdw.makeEpochStrFrom('2023-11-22T02:41:24.941Z')
// console.log(pdw.parseTemporalFromEpochStr(epoch!).toLocaleString());
// console.log(pdw.parseTemporalFromEpochStr(epoch2!).toLocaleString());

// const temp = pdw.parseTemporalFromEpochStr(epoch!);
// console.log(

//     temp.toPlainDateTime().toString()
// );


// import * as whatever from '../real-data/'

const pdwRef = pdw.PDW.getInstance();

importFromFile('real-data/round2/intermediate/active-manifest.yaml');

let all = await pdwRef.getAll({includeDeleted: 'no'});

importOldest('real-data/round2/raw-source/4-2013-to-7-2020.csv');
// importFirestore('real-data/round2/raw-source/in-firestore.json');
// // importMongo('real-data/round2/raw-source/in-mongo.json');

// all = await pdwRef.getAll({includeDeleted: 'no'});

// exportToFile('real-data/round2/output/firestore/firestore-processed.xlsx', all)
// exportToFile('real-data/round2/output/firestore/firestore-processed.json', all)
// exportToFile('real-data/round2/output/firestore/firestore-processed.yaml', all)
// exportToFile('real-data/round2/output/firestore/firestore-processed.csv', all)
